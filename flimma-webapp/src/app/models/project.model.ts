...
type ToolType = 'Select' | 'Flimma'; // ADD THE TOOL NAME(S) HERE
type AlgorithmType = 'Select' | 'Limma-Voom'; // ADD THE ALGORITHM NAME(S) HERE
...
export class ProjectModel extends BaseModel<ProjectJson> {
  ...
  private _minTotalCount: number;
  private _group1: string;
  private _group2: string;
  private _confounders: string;
  // END Stats TOOL SPECIFIC ATTRIBUTES
  ...
  public async refresh(proj: ProjectJson) {
    ...
    // BEGIN Stats TOOL SPECIFIC ATTRIBUTES
    this._normalization = proj.normalization;
    this._minCount = proj.min_count ;
    this._minTotalCount = proj.min_total_count;
    this._group1 = proj.group1;
    this._group2 = proj.group2;
    this._confounders = proj.confounders;
    // END Stats TOOL SPECIFIC ATTRIBUTES
  }
  ...
  // BEGIN Stats TOOL SPECIFIC ATTRIBUTES
  public get normalization(): string {
  ...
  public get minTotalCount(): number {
    return this._minTotalCount;
  }

  public get group1(): string {
    return this._group1;
  }

  public get group2(): string {
    return this._group2;
  }

  public get confounders(): string {
    return this._confounders;
  }
  // END Stats TOOL SPECIFIC ATTRIBUTES
